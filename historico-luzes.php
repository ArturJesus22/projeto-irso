...
// Luzes
$luzes=mysqli_query($con, "SELECT * FROM luzes");
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2">Histórico do sistema de luzes</h1>    
            </div>
            ...
            <div class="row"> 
                    <table class="table">
                        <thead>
                            <tr>
                                <th scope="col">#</th>
                                <th scope="col">Sensor de deteção de movimento</th>
                                <th scope="col">Luzes do armazém</th>
                                <th scope="col">Data e hora</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php while($resLuzes=mysqli_fetch_assoc($luzes)): ?>
                            <tr>
                                <th scope="row"><?php echo $resLuzes["id"]; ?></th>
                                <td>
                                    <?php
                                        if($resLuzes["valor"]==0) {
