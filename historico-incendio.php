...
// Incêndio
$incendio=mysqli_query($con, "SELECT * FROM incendio");
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2">Histórico do sistema de incêndio</h1>    
            </div>
            ...
            <div class="row"> 
                    <table class="table">
                        <thead>
                            <tr>
                                <th scope="col">#</th>
                                <th scope="col">Sensor de deteção de fogo</th>
                                <th scope="col">Extintor de incêndio</th>
                                <th scope="col">Data e hora</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php while($resIncendio=mysqli_fetch_assoc($incendio)): ?>
                            <tr>
                                <th scope="row"><?php echo $resIncendio["id"]; ?></th>
                                <td>
                                    <?php
